...
import numpy
# import ctypes
# ctypes.CDLL('venv/Lib/site-packages/torch/lib/libtorch_global_deps.so', mode=ctypes.RTLD_GLOBAL)
import torch
import librosa
import time
...
if __name__ == "__main__":
    ...
    parser.add_argument("--hpfile", type=str, default="configs/freevc-s.json", help="path to json config file")
    parser.add_argument("--ptfile", type=str, default="logs/freevc-s/G_600000.pth", help="path to pth file")
